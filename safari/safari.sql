...
(31, 'Ayrton Steffich', 'ayrton.steffich@gmail.com', '+5491136002930', 'http://localhost/safari_group/safari/storage/app/cvs/1652740181Ayrton\'s Resume.pdf', '2022-05-05 17:34:28', '2022-05-17 01:29:41', 'http://localhost/safari_group/safari/public/job_postings'),
...
--
-- Estructura de tabla para la tabla `applicant_job_posting`
--

DROP TABLE IF EXISTS `applicant_job_posting`;
CREATE TABLE IF NOT EXISTS `applicant_job_posting` (
  `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT,
...
--
-- Volcado de datos para la tabla `applicant_job_posting`
--

INSERT INTO `applicant_job_posting` (`id`, `applicant_id`, `job_posting_id`, `status`, `created_at`, `updated_at`) VALUES
(1, 1, 1, '', NULL, NULL),
(2, 1, 14, '', NULL, NULL),
(3, 2, 1, '', NULL, NULL),
(4, 2, 4, '', NULL, NULL),
...
INSERT INTO `job_postings` (`id`, `name`, `company_name`, `description`, `location`, `currency`, `status`, `requirements`, `hiring_modality`, `work_modality`, `english_level`, `seniority`, `created_at`, `updated_at`, `user_id`) VALUES
...
(5, '2022_04_29_181048_create_job_postings_table', 1),
(6, '2022_05_05_021421_create_applicants_table', 1),
(7, '2022_05_05_121858_latest', 1),
(8, '2022_05_05_123018_applicant_job_posting_table', 1);
...
ALTER TABLE `job_postings`
  ADD CONSTRAINT `job_postings_user_id_foreign` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`);
COMMIT;
