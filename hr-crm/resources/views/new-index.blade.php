...
<head>
	...
	<!-- Favicon  -->
    <link rel="icon" href="{{asset('images/favicon-LTK.png')}}">
</head>
<body data-spy="scroll" data-target=".fixed-top">
    ...
    <nav class="navbar navbar-expand-lg navbar-dark navbar-custom fixed-top">
        ...
        <!-- Image Logo -->
        <a class="navbar-brand logo-image" href="index.html"><img src="{{asset('images/ltk-white.png')}}" alt="alternative"></a>
        ...
        <div class="collapse navbar-collapse" id="navbarsExampleDefault">
            ...
            <div class="dropdown">
                ...
                <div class="dropdown-menu" aria-labelledby="dropdownMenu2">
                  <a href="#" class="dropdown-item" type="button"> <span class="flag-icon flag-icon-ar flag-icon-squared"></span> Español</a>
                  <a href="#" class="dropdown-item" type="button"><span class="flag-icon flag-icon-us flag-icon-squared"></span> English</a>
                ...
                <div class="row">
                    <div class="col-lg-6">
                        <div class="text-container">
                            <h1 class="text_grey"><span class="text_black">Lean Tool Kit</span> Tech Solutions</h1>
                            <p class="p-large text_black">Software Engineering combined with data science.</p>
                    ...
                    <div class="col-lg-6">
                        <div class="image-container header__image-container">
                            <img class="img-fluid header__img-fluid" src="{{asset('images/LTK.png')}}" alt="alternative">
                            <a class="btn-solid-lg page-scroll" href="#services">Finance App</a>
                       
                            <a class="btn-solid-lg page-scroll" href="#services">HR CRM</a>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <!-- Card -->
                    <div class="card card__projects">
                        
                        <div class="card-body ">
                            <!-- <h4 class="card-title">Finance App</h4> -->
                            <a class="btn-solid-lg btn-solid--app page-scroll card-title" href="#services">Finance App</a>
                        </div>
                      
                    </div>
                    <!-- <a class="btn-solid-lg btn-solid__projects page-scroll" href="#services">Finance App</a> -->
                    <!-- end of card -->
                    ...
                    <div class="card card__projects">
                        ...
                        <div class="card-body ">
                            <!-- <h4 class="card-title">Human Resources CRM</h4> -->
                            <a class="btn-solid-lg btn-solid--app page-scroll card-title" href="#services">HR CRM</a>
                        </div>
                        
                    </div>
                    <!-- <a class="btn-solid-lg btn-solid__projects page-scroll" href="#services">Human Resources CRM</a> -->
                    <!-- end of card -->
            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="team-member">
                        ...
                        <p class="p-large"><strong>Ayrton Steffich</strong></p>
                    ...
                    <div class="team-member">
                        ...
                        <p class="p-large"><strong>Juan Lapelegrina</strong></p>
                    ...
                    <div class="team-member">
                        ...
                        <p class="p-large"><strong>Christian Fontana</strong></p>
            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <ul class="list-unstyled li-space-lg">
                        ...
                        <li><i class="fas fa-map-marker-alt"></i>xxxxxxxxxxxxxxxxxx, US</li>
                        <li><i class="fas fa-phone"></i><a class="turquoise" href="tel:003024630820">+11 111 111</a></li>
                        <li><i class="fas fa-envelope"></i><a class="turquoise" href="mailto:office@evolo.com">ltk@ltk.com</a></li>
                    </ul>
                </div> <!-- end of col -->
            </div> <!-- end of row -->
            <div class="row">
