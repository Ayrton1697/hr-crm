...
<head>
    ...
    <link rel="preconnect" href="https://fonts.googleapis.com">
    <link rel="preconnect" href="https://fonts.gstatic.com" crossorigin>
    <link href="https://fonts.googleapis.com/css2?family=Raleway:ital,wght@0,200;0,300;0,400;0,500;1,400;1,500&display=swap" rel="stylesheet">
...
<body data-spy="scroll" data-target=".fixed-top">
    ...
    <nav class="navbar navbar-expand-lg navbar-dark navbar-custom fixed-top top-nav-collapse">
        ...
        <!-- Image Logo -->
        <!-- <a class="navbar-brand logo-image" href="{{route('index')}}"><img src="{{App::getLocale()=='en' ? asset('images/logo/new-logo.png') : (App::getLocale()=='es' ? asset('images/new-logo.png') : null)}}" alt="alternative"></a> -->
        ...
        <div class="collapse navbar-collapse" id="navbarsExampleDefault">
            <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item">
                    <a class="nav-link page-scroll" href="{{route('JobPostings')}}">{{__('Active Openings')}}</a>
                </li>
                <li class="nav-item">
                ...
                <div class="row">
                    <div class="col-lg-6">
                        <div class="text-container">
                            <h1 class="text_black"><span class="text_grey">Lean Tool Kit</span> HR CRM</h1>
                            <p class="p-large text_black">Find the best match for your company.</p>
                            <a class="btn-solid-lg page-scroll" href="#services">GET STARTED</a>
                       
                        </div> <!-- end of text-container -->
                    </div> <!-- end of col -->
                    <div class="col-lg-6">
                        <div class="image-container header__image-container">
                            <img class="img-fluid header__img-fluid" src="{{asset('images/new-logo-black.png')}}" alt="alternative">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="p-heading">
                        ...
                        <!-- <a href="#" target="_blank" class="btn-solid-reg" >{{__('Us button')}}</a> -->
                    </div> <!-- end of text-container -->
                </div> <!-- end of col -->
                <!-- <div class="col-lg-6">
 ...
 -->
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-4">
                    ...
                    <p>Do you need to build lists for your email campaigns? It just got easier with HR CRM.</p>
    ...
    <div id="contact" class="form-2">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="mb-5 text-center">{{__('Contact')}}</h1>
                    <ul class="list-unstyled li-space-lg">
                      <!--   <li class="address">Don't hesitate to give us a call or send us a contact form message</li>
                        ...
                        <li class="contact__links"><i class="fas fa-envelope"></i><a href="#">crhrm@ltk.com</a></li>
                        <li class="contact__links"><i class="fas fa-phone"></i><a  href="#">+54911111111</a></li>
                    </ul>
                </div> <!-- end of col -->
            </div> <!-- end of row -->
            <div class="row">
